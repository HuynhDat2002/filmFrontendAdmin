...
import { createMovie } from '@/lib/features/movie.slice';
...
const handleSubmit = (event:any)=>{
    ...
    dispatch(createMovie({urlEmbed:urlEmbed}))
}
const handleError = () => {
    setError(false),
      setMessageError("")
  ...
  useEffect(()=>{
    if(movieState.isSuccess && movieState.isCreateMovie) setIsOpenSuccess(true)
    if(movieState.isError && movieState.isCreateMovie){
        setError(true)
